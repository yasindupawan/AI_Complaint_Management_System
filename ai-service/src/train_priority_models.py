...
print("\n" + "=" * 75)
print("BEST DEVELOPMENT PRIORITY MODEL")
print("=" * 75)
...
print(
    "\nNOTE:"
    "\nThese are development results from a "
    "train/test split of the V2 priority dataset."
    "\nA separately authored unseen priority dataset "
    "must be used before selecting the final model."
)